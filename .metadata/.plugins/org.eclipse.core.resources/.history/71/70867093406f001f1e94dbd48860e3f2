...
public class B_List {
	public static void main(String[] args) {
		...
		System.out.println(strArray); // [JAVA, PYTHON, JS, TS] >> 넣은 순서대로 배열 출력
		...
		System.out.println(strArray.set(1, "C++")); // PYTHON >> 바뀌기 전 1번 인덱스 값이 출력
		System.out.println(strArray); // [JAVA, C++, JS, TS] >> 1번 인덱스 값이 바뀐 후 배열 리스트 출력
